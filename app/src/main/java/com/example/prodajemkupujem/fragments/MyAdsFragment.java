...
import com.example.prodajemkupujem.databinding.FragmentMyAdsBinding;
...
public class MyAdsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.tabLayout.addTab(binding.tabLayout.newTab().setText("Oglasi"));
        binding.tabLayout.addTab(binding.tabLayout.newTab().setText("Omiljeno"));
